...
namespace Psiholog
{
    class WStudii : Clasificator
    {
        ...
        public WStudii(MySqlConnection _connection)
        {
        ...
        public override MySqlDataReader GetValues()
        {
            if (connection.State == ConnectionState.Open)
            {
                ...
                connection.Open();
            MySqlCommand cmd = new MySqlCommand("SelectStudii", connection);
        ...
        public override MySqlDataReader Search(string _paramsearch)
        {
            ...
            MySqlCommand cmd = new MySqlCommand("SelectStudiiByName", connection);
            cmd.CommandType = CommandType.StoredProcedure;

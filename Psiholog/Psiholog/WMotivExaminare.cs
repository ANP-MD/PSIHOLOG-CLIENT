...
namespace Psiholog
{
    class WMotivExaminare : Clasificator
    {
        ...
        public WMotivExaminare(MySqlConnection _connection)
        {
        ...
        public override MySqlDataReader GetValues()
        {
            if (connection.State == ConnectionState.Open)
            {
                ...
                connection.Open();
            MySqlCommand cmd = new MySqlCommand("SelectMotiveExaminare", connection);
        ...
        public override MySqlDataReader Search(string _paramsearch)
        {
            ...
            MySqlCommand cmd = new MySqlCommand("SelectMotivExaminareByName", connection);
            cmd.CommandType = CommandType.StoredProcedure;

...
namespace Psiholog
{
    class WStareCivila : Clasificator
    {
        ...
        public WStareCivila(MySqlConnection _connection)
        {
        ...
        public override MySqlDataReader GetValues()
        {
            if (connection.State == ConnectionState.Open)
            {
                ...
                connection.Open();
            MySqlCommand cmd = new MySqlCommand("SelectStareCivila", connection);
        ...
        public override MySqlDataReader Search(string _paramsearch)
        {
            ...
            MySqlCommand cmd = new MySqlCommand("SelectStareCivilaByName", connection);
            cmd.CommandType = CommandType.StoredProcedure;

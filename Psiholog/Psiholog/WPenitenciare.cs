...
namespace Psiholog
{
    class WPenitenciare : Clasificator
    {
        ...
        public WPenitenciare(MySqlConnection _connection)
        {
        ...
        public override MySqlDataReader GetValues()
        {
            if (connection.State == ConnectionState.Open)
            {
                ...
                connection.Open();
            MySqlCommand cmd = new MySqlCommand("SelectPenitenciare", connection);
        ...
        public override MySqlDataReader Search(string _paramsearch)
        {
            ...
            MySqlCommand cmd = new MySqlCommand("SelectPenitenciareByName", connection);
            cmd.CommandType = CommandType.StoredProcedure;

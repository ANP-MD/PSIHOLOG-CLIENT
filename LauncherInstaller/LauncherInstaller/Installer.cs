...
namespace AkulavLauncherInstaller
{
    ...
    {
        readonly static string location = "C:\\Psiholog\\";
        readonly string fileLocation = "C:\\Psiholog\\file.zip";
        readonly string updateFlag = "C:\\Psiholog\\update.txt";
        ...
        private void InstallBtn_Click(object sender, EventArgs e)
        {
            ...
            link.SetDescription("A Data Client");
            link.SetPath(@"C:\\Psiholog\\Psiholog.exe");

            // save it
            IPersistFile file = (IPersistFile)link;
            string desktopPath = Environment.GetFolderPath(Environment.SpecialFolder.DesktopDirectory);
            file.Save(Path.Combine(desktopPath, "Psiholog.lnk"), false);

            var p = new Process();
            p.StartInfo.FileName = @"C:\Psiholog\Psiholog.exe";
            p.Start();
        ...
        private void UninstallBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                File.Delete(Path.Combine(desktopPath, "Psiholog.lnk"));
